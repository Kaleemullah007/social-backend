 ...
 input {
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('View result') }} Correct:{{ $result->correct_answer }},   Wrong:{{ $result->wrong_answer }} Result Status : <span class="badge badge-primary bg-primary"> {{ucfirst($result->status)}} </span></div>
